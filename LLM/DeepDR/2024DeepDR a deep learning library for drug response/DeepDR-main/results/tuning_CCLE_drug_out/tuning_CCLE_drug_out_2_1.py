...
for seed in seeds:
    ...
    """"""
    lab = 'CCLE_drug_out'
    txt_path = 'tuning_CCLE_drug_out_2_1.txt'
    data_path = 'CCLE_ActArea_drug_out_seed={}.pkl'.format(seed)

    model_ls = ['DAE(EXP_ALL)_MPG(Graph)_DNN']
    ...
    drug_encoder_ls = [DrugEncoder.MPG(ft_dim=64)]

    fusion_module_ls = [FusionModule.DNN(cell_dim=100, drug_dim=64)]
    """"""
