...
model_ls = ['DNN(EXP)_DNN(ECFP)_DNN',
            ...
            'CNN(EXP_ALL)_DNN(ECFP)_DNN',
            'DAE(EXP_ALL)_DNN(ECFP)_DNN',
            'DNN(EXP_ALL)_CNN(SMILES)_DNN',
            'DNN(EXP_ALL)_AFP(Graph)_DNN',
            'DNN(EXP_ALL)_MPG(Graph)_DNN',
            'DNN(EXP_ALL)_MPG(Graph)_MHA',
            'tCNNS',
            'Precily',
            'DeepDSC']
